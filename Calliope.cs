...
/*
This is a personal research project to learn more about social networks and clustering analysis. I made a character creation engine that's extensible and scalable for this experiment. It's a C# command-line program that outputs data to be copied into the Google Sheet for analysis. I primarily used Visual Studio Code for development, as I prefer the simplicity of that IDE, but did unit testing in Visual Studio 2019 to identify and improve performance bottlenecks.

The end goal is a "narrative legos" system as described by Ken Levine in his 2014 GDC talk, procedurally generating characters and their relationships. This would likely compliment traditional character design instead of replacing it. Game writers would create a few characters to introduce the player to the setting, and the procedural system fills out the rest. This would address a core problem of open world games in particular, where they feel wide but shallow, with lots of non-interactable NPCs titled "Villager." It would also bring down production costs for studios, since many characters, stories, and quests currently created by hand could be generated by a procedural system.

Data analysis: https://docs.google.com/spreadsheets/d/1m5U0FIjLtp8r34ESwPfddWgP9zqWPZv_ZiYj43BfVpw/edit?usp=sharing
*/
